...
I made a violin plot and also a density plot to see the distribution of ride duration.
First, let's try the violin plot
```{r}
 citibike24_df = 
   citibike_df|> 
   filter(year == 2024)
...
```
Comment: 
1. Electric bikes tend to have a broader range of ride durations compared to classic bikes.
2. Members tend to have more consistent ride durations with a narrower distribution, especially visible in the plots for July. 
3.Rides in July, for both bike types and user types, tend to have a slightly wider range of durations.


Make another density plot to focus more closely on the relevant parts of the data,
I want to see the specific part contains only 0-100 minutes.
