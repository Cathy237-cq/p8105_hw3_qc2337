...
Comment: Compare to weekday, the median ride duration is longer on weekends in 2020. For each year, July has the longer the median ride duration than January.
In 2024, the median ride duration on Sunday has a drop compare to Saturday.
2024 has a shorter median ride duration than 2020 in both January and July.
...
Comment: Both class and electric bikes show a peak that usually in ride duration within 30 minutes. This means that most rides, regardless of bike type or user membership, are relatively short.
Electric bikes tend to have a slightly longer ride duration compared to classic bike.
Members tend to use classic bikes more consistently, with their distribution being sharper and more centered around shorter durations.
